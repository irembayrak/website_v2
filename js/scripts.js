...
function scrollFunction() {
  if (window.innerWidth >= 640) {
    if (document.body.scrollTop > 101 || document.documentElement.scrollTop > 101) {
      document.getElementById("navbar").style.padding = "5px 0 3px";
      ...
      document.getElementById("menuhome").style.fontSize = "16px";
      document.getElementById("shrink").style.margin = "0.5em 0";
    } else {
      document.getElementById("navbar").style.padding = "10px 0 13px";
      ...
      document.getElementById("menuhome").style.fontSize = "18px";
